...
struct tio {
       ...
       page_t **pvec; /* array of pages holding data */
...
#define ISCSI_CONN_IOV_MAX	(((256 << 10) >> IET_PAGE_SHIFT) + 1)
...
#else
	struct crc32c_ctx rx_hash;
	struct crc32c_ctx tx_hash;
#endif
};
