...
#else
/* 
 * copy_to_user/copy_from_user would mean copyout/copyin
 * But defining these would make the diff smaller
 */
static int
copy_to_user(void *ptr, void *info, int size)
{
...
static int
copy_from_user(void *info, void *ptr, int size)
{
